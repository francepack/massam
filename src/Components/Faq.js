...
const pics = [
  'w_400,h_270/PXL_20210415_011953131_2_sqlilk',
  'w_300,h_200/PXL_20210410_162955617_exported_18284_zxr6fa',
  'w_300,h_200/PXL_20210425_012430590_aneyfd',
  'w_300,h_200/PXL_20210530_173951377_oa0dzx',
  'w_300,h_200/PXL_20210327_234948286_dowa50',
  'w_300,h_200/PXL_20210327_234938269_tx6lqg',
  'w_300,h_200/PXL_20210319_230645380_zegmvy'
];
...
const a4 = () => {
  return(
    <div>
      ...
      {pics.map(pic => {
        const url = 'https://res.cloudinary.com/drerpvd8x/image/upload/' + pic;
        return(
          <div>
            <img src={url} />
          </div>
